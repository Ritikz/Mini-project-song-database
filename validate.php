...
if(isset($_POST['forgot'])){
    ...
    if(mysqli_num_rows($result)==0){
        ...
        $mail->Username = 'dhirenparekh713@gmail.com';                 // SMTP username
        $mail->Password = 'HaR_potter';                         // SMTP password
        $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 587;                                    // TCP port to connect to
        $to=$email_address;
        $mail->setFrom('dhirenparekh713@gmail.com', 'Songs Hub');
        ...
        You recently requested to reset your password for your Songs Hub account.Click the button below to reset it. <br>
        <br><br>
        
        <button type='button' class='btn btn-secondary'><a href='http://localhost/Songs-Hub/reset_password.php'>Reset Password</a></button>
